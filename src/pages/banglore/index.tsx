      ...
      <div className="travel-container">
        ...
        <header className="travel-hero">
          <div className="hero-content">
            <h1 className="hero-title">GIDS Bangalore 2024</h1>
            <p className="hero-subtitle">
              Exploring cutting-edge AI, GenAI, Backend Development and
              TypeScript
            </p>
          ...
          <div className="hero-image">
            <img
              src={require("@site/static/img/gids/gids5.jpg").default}
          ...
          <div className="container">
            ...
            <article className="destination-card">
              <div className="destination-image">
                <img
                  src={require("@site/static/img/gids/gids6.jpg").default}
                  alt="GIDS Conference Hall"
                />
                <div className="destination-overlay">
                  <span className="duration">August 2024</span>
          ...
          <div className="container">
            ...
            <div className="gallery-grid">
              ...
              <div className="gallery-item">
                <img
                  src={require("@site/static/img/gids/gids_card.jpg").default}
                  alt="AI Workshop"
                />
            ...
            <article className="destination-card reverse">
              ...
              <div className="destination-content">
                ...
                <p className="destination-description">
                  ...
                  ecosystem. Known as India's Silicon Valley, the city is home
                  to numerous tech giants, innovative startups, and research
                  centers pushing the boundaries of AI, cloud computing, and
                ...
                <div className="highlights">
                  ...
                  <ul className="highlights-list">
                    ...
                    <li>
                      <span className="highlight-icon">✨</span>Startup
